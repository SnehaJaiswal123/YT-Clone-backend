...
const router=Router();
import { Register, changeCurrentPass, login, logout, refreshAccessToken, updateAccountDetails, updateAvatar, updateCoverImage, getCurrentUser,subscribeToChannel, getChannelProfile} from "../controllers/user.controller.js";
...
router.get('/channelProfile/:userId', jwtVerify, getChannelProfile);
